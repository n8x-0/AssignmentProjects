...
let timerCont: any = select("#timerCont") as HTMLDivElement;
...
let startButton = select("#startButton") as HTMLButtonElement;
let pauseBtn = select("#pauseBtn") as HTMLButtonElement;
let resetBtn = select("#resetButton") as HTMLButtonElement;
